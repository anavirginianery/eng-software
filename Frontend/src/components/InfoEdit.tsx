...
export default function Perfil() {
  ...
  useEffect(() => {
    if (id) {
      // Simulando dados com a função de mock
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Aqui você faria o envio dos dados para o backend, por exemplo:
    router.push("/perfil-atualizado"); // Exemplo de redirecionamento após envio
  };
